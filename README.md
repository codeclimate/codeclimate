...
This will generate .yml files that will enable CodeClimate CLI to run with the configuration that is automatically generated by the Code Climate webapp, ensuring that the output matches between the two.
