...
RSpec.describe CC::CLI::VersionChecker do
  ...
  it "checks version against the API" do
    stub_version_request(version: "0.1.2", outdated: true)
  ...
  it "prints nothing when up to date" do
    stub_version_request(version: "0.1.2", outdated: false)
  ...
  it "uses cached values when API is unavailable" do
    stub_resp("versions.codeclimate.com", "255.255.255.255", Net::HTTPServerError.new(500, "Nope", "Nope Nope"))
